...
import { MOCK_INSTITUTIONS, DEPARTMENTS, REGION_DATA } from '../lib/constants';
              ...
              <div className="space-y-4">
                ...
                {activeTab === 'doctor' ? (
                  ...
                  <div className="flex flex-col md:flex-row gap-4 items-center">
                    ...
                    <button 
                      onClick={() => navigate(`/region/${activeSido}/${activeSigungu}`)}
                      className="w-full md:w-auto bg-primary text-white font-semibold px-8 py-3 rounded-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all"
                    >
                      지역별 검색
                    </button>
                  </div>
